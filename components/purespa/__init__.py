...
sbh_ns = cg.esphome_ns.namespace('purespa')

PureSpa = sbh_ns.class_('PureSpa', cg.Component)
PureSpaClimate = sbh_ns.class_('PureSpaClimate', climate.Climate)
PureSpaSwitch = sbh_ns.class_('PureSpaSwitch', switch.Switch)
